    ...
    return `
      ...
      <div class="chart-section">
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:9px" class="paye-monthly">
          <div style="text-align:center;background:var(--g50);border:1px solid var(--br);border-radius:9px;padding:14px"><div style="font-family:var(--serif);font-size:18px;font-weight:700;color:var(--navy)">${fmt(r.annual/12,0)}</div><div style="font-size:10px;color:var(--t3);margin-top:3px">Gross / month</div></div>
          <div style="text-align:center;background:var(--g50);border:1px solid var(--br);border-radius:9px;padding:14px"><div style="font-family:var(--serif);font-size:18px;font-weight:700;color:var(--red)">${fmt(r.incomeTax/12,0)}</div><div style="font-size:10px;color:var(--t3);margin-top:3px">Tax / month</div></div>
          <div style="text-align:center;background:var(--g50);border:1px solid var(--br);border-radius:9px;padding:14px"><div style="font-family:var(--serif);font-size:18px;font-weight:700;color:var(--amber)">${fmt(r.empNI/12,0)}</div><div style="font-size:10px;color:var(--t3);margin-top:3px">NI / month</div></div>
          <div style="text-align:center;background:var(--bluel);border:1px solid var(--bluel2);border-radius:9px;padding:14px"><div style="font-family:var(--serif);font-size:18px;font-weight:700;color:var(--blue2)">${fmt(r.netPay/12,0)}</div><div style="font-size:10px;color:var(--blue2);margin-top:3px;font-weight:600">Net / month</div></div>
        </div>
      </div>
