...
window.TOOLS = [
  ...
  // v4 additions — Employee NI, Gross-to-Net, Marginal Relief, SPP, SAP, ShPP
  { id:'employee-ni',   cat:'Payroll',     icon:'👤', title:'Employee NI Calculator',                desc:'Class 1 primary contributions — 8% on £12,570–£50,270, then 2% above. Annual/monthly/weekly views.',                 tags:['Class 1','8% / 2%','PT → UEL'],         badge:'tb-new', badgeText:'New',      color:'tc-green',  iconBg:'ti-green'  },
  { id:'gross-to-net',  cat:'Payroll',     icon:'➡',  title:'Gross-to-Net Salary Calculator',        desc:'Convert any gross salary to net across annual, monthly, weekly, daily and hourly frequencies.',                   tags:['Frequency table','Hourly','Daily'],     badge:'tb-new', badgeText:'New',      color:'tc-blue',   iconBg:'ti-blue'   },
